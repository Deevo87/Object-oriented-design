...
public class PropertiesPanel extends JPanel {
	...
	public void fillProperties() {
		...
		switch (shopController.getCurrentCategory()) {
			case BOOKS -> add(createPropertyCheckbox("Twarda oparawa", new ActionListener() {
				@Override
				public void actionPerformed(ActionEvent event) {
					filter.getItemSpec().setCover(
							((JCheckBox) event.getSource()).isSelected());
					shopController.filterItems(filter);
				}
			}));
			...
			case MUSIC -> add(createPropertyCheckbox("Video", new ActionListener() {
